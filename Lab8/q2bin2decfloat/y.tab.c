...
{
  "$end", "error", "$undefined", "ONE", "ZERO", "DECIMAL", "$accept",
  "BinNo", "BinDigPreDeci", "BinDigPostDeci", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  case 3:
#line 39 "q2.y"
                                 {num = num + (1<<preidx); printf("e %d", (1<<preidx)); preidx++ ; }
#line 1321 "y.tab.c"
    break;
...
#line 1327 "y.tab.c"
  ...
  case 7:
#line 44 "q2.y"
                                     {num = num + (1.0/(1<<postidx)); printf("%lf",num) ; /*printf("o %lf", 1.0/(1<<postidx))*/; postidx++ ;printf("here1");  }
#line 1333 "y.tab.c"
    break;

  case 8:
#line 45 "q2.y"
                         {postidx++; printf("here0"); }
#line 1339 "y.tab.c"
    break;
